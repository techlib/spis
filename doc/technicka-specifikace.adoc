...
Za účelem sestavování rozpočtových dokumentů bude třeba komponenty, která umožní výběr a upřesnění položek ze závislostí. Součástí této komponenty bude dost možná i jeden či více diagramů, které poskytnou rychlou orientaci ve výsledné finanční situaci.

Podobných zvláštních případů se může postupem času objevit více.
