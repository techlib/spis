...
Každá komponenta by měla podporovat zobrazení kontextové nápovědy intuitivním způsobem a to alespoň na úrovni komponenty jako celku. U těch složitějších však lze předpokládat nápovědu u jednotlivých prvků. Nutností je také podpora lokalizace nápovědy.
