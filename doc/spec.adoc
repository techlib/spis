...
Přehledy jsou klíčovou součástí systému umožňující generování statistik. Poskytují uživatelům vhled do současného, dřívějšího a někdy i možného budoucího stavu věcí. Právě na jejich základě zahajují uživatelé projekty a svými dokumenty mění jejich stav.
